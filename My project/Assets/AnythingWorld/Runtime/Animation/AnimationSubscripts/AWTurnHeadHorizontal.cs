...
{
    /// <summary>
    /// Animation subscript handling horizontal turning of head.
    /// </summary>
    public class AWTurnHeadHorizontal : AnythingAnimationComponent
    {
        #region Fields
        /// <summary>
        /// The speed of the head rotation
        /// </summary>
        ...
        void Update()
        {
            transform.localRotation = Quaternion.Euler(0f, MaxRotation * Mathf.Sin(Time.time * TurnSpeed), 0f);
        }
        #endregion
