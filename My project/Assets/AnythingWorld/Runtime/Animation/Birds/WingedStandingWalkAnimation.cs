...
{
    /// <summary>
    /// Animation controller for the WingedStanding walk animation.
    /// </summary>
    public class WingedStandingWalkAnimation : AnythingAnimationController
    {
        #region Fields
        // Animation settings
        ...
        public float rightFrontLegMovementRadius = 0.8f;
        public float leftFrontLegMovementRadius = 0.8f;
        ...
        {
            FetchAnimationSettings("winged_standing__walk", "walk");
