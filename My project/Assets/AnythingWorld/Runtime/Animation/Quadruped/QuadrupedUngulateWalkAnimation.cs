...
{
    public class QuadrupedUngulateWalkAnimation : AnythingAnimationController
    {
        ...
        public override void InitializeAnimationParameters()
        {
            ...
            FetchAnimationSettings("quadruped_ungulate", "walk");
        ...
        protected override void UpdateParameters()
        {
            ...
            {
                Debug.LogError($"Error when updating parameters: {e}");
            }
        }
