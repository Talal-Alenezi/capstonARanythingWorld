...
namespace PathCreation
{
    ...
    public class BezierPath
    {
        ...
        public void SetControlPoints(List<Vector3> _points)
        {
        ...
        public List<Vector3> GetAnchorPointList()
        {
        ...
        public List<Vector3> GetControlPointList()
        {
        ...
        public void LoadAnchorNormalsFromList(List<float> angleList)
        {
            ...
            {
                //Debug.Log("Incorrect number of normals");
            }
